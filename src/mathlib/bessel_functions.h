#ifndef _BESSEL_FUNCTIONS_H
#define _BESSEL_FUNCTIONS_H
...
//
inline int bessjy01a(double x,double &j0,double &j1,double &y0,double &y1,
...
//
inline int bessjy01b(double x,double &j0,double &j1,double &y0,double &y1,
    double &j0p,double &j1p,double &y0p,double &y1p)
{
...
//
inline int bessjyna(int n,double x,int &nm,double *jn,double *yn,
...
//
inline int bessjyv(double v,double x,double &vm,double *jv,double *yv,
...
inline int bessik01a(double x,double &i0,double &i1,double &k0,double &k1,
...
inline int bessik01b(double x,double &i0,double &i1,double &k0,double &k1,
    double &i0p,double &i1p,double &k0p,double &k1p)
{
...
inline int bessikna(int n,double x,int &nm,double *in,double *kn,
...
inline int bessiknb(int n,double x,int &nm,double *in,double *kn,
    double *inp,double *knp)
{
...
//          K-v(x) = Kv(x)
//
inline int bessikv(double v,double x,double &vm,double *iv,double *kv,
...
inline int cbessjy01(complex<double> z,complex<double> &cj0,complex<double> &cj1,
...
inline int cbessjyna(int n,complex<double> z,int &nm,complex<double> *cj,
...
inline int cbessjynb(int n,complex<double> z,int &nm,complex<double> *cj,
    complex<double> *cy,complex<double> *cjp,complex<double> *cyp)
{
...
inline int cbessik01(complex<double>z,complex<double>&ci0,complex<double>&ci1,
...
inline int cbessikna(int n,complex<double> z,int &nm,complex<double> *ci,
...
inline int cbessiknb(int n,complex<double> z,int &nm,complex<double> *ci,
    complex<double> *ck,complex<double> *cip,complex<double> *ckp)
{
...
inline int cbessjyva(double v,complex<double> z,double &vm,complex<double>*cjv,
...
inline int cbessikv(double v,complex<double>z,double &vm,complex<double> *civ,
