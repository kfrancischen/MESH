...
namespace QuadPack
{
	...
	*/	
		 ...
		 */
		template <class Func>
		int qag(Func& f, const Real& a, const Real& b,
				  const Real& epsabs, const Real& epsrel, Real& result, Real& abserr);
	private:
	...
	int Workspace<Real>::qag(Func& f, const Real& a, const Real& b,
								const Real& epsabs, const Real& epsrel, Real& result, Real& abserr)
	{
		Real area, errsum;
